...
if __name__=="__main__":
    ...
    # mol.plot_diagonalized_kernel_isodensity_slider(grid_points=(25,25,25),number_eigenvectors=40,delta=5)
    # mol.plot_diagonalized_kernel_isodensity_slider(grid_points=(60,60,60),number_eigenvectors=40,delta=10,method="partial")
