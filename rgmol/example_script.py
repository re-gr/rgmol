...
if __name__=="__main__":
    ...
    # file = "output_examples//formaldehyde//H2CO.mo19a.cube"
    ...
    transition_energy,transition_list,transition_factor_list = rgmol.extract_excited_states.extract_transition_orca("output_examples//formaldehyde//H2CO.out")
    ...
    # transition_energy,transition_list,transition_factor_list = rgmol.extract_excited_states.extract_transition_orca("output_examples//formaldehyde_huge//H2CO.out")
    ...
    # mol.plot_AO_pyvista(delta=5,grid_points=(60,60,60),opacity_radius=.9,opacity=.8)
    # mol.plot_MO_pyvista(delta=8,grid_points=(80,80,80),opacity_radius=.9)
    # mol.plot_transition_density_pyvista(delta=5,grid_points=(60,60,60),opacity_radius=.4)
    # mol.plot_diagonalized_kernel_isodensity_slider_pyvista(grid_points=(25,25,25),number_eigenvectors=40,delta=5)
    mol.plot_diagonalized_kernel_isodensity_slider_pyvista(grid_points=(60,60,60),number_eigenvectors=40,delta=10,method="partial")
